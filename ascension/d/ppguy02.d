...
IF ~Global("Pool2Active","AR6200",2)~ THEN a2
  ...
  IF ~Global("Pool1Active","AR6200",3) Global("Pool3Active","AR6200",3)~ THEN JOURNAL @6 GOTO a6
  IF ~!Global("Pool1Active","AR6200",3) Global("Pool3Active","AR6200",3)~ THEN JOURNAL @6 GOTO a7
  IF ~Global("Pool1Active","AR6200",3) !Global("Pool3Active","AR6200",3)~ THEN JOURNAL @6 GOTO a7
...
IF ~Global("Pool3Active","AR6200",2)~ THEN a3
  ...
  IF ~Global("Pool1Active","AR6200",3) Global("Pool2Active","AR6200",3)~ THEN JOURNAL @9 GOTO a8
  IF ~Global("Pool1Active","AR6200",3) !Global("Pool2Active","AR6200",3)~ THEN JOURNAL @9 GOTO a9
  IF ~!Global("Pool1Active","AR6200",3) Global("Pool2Active","AR6200",3)~ THEN JOURNAL @9 GOTO a9
