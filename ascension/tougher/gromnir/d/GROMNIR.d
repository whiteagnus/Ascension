...
ALTER_TRANS GROMNIR BEGIN 7 END BEGIN END BEGIN "ACTION" ~ClearAllActions() StartCutSceneMode() EraseJournalEntry(64995) EraseJournalEntry(65001) EraseJournalEntry(65003) Enemy() SetGlobalTimer("reinfg","GLOBAL",10) CreateCreature("GROMG03",[781.596],%FaceW%) CreateCreature("GROMG09",[832.609],%FaceW%) CreateCreature("GROMG10",[778.636],%FaceW%) EndCutSceneMode() ActionOverride("gromg03",Shout(ALERT)) ActionOverride("gromg03",Enemy()) ActionOverride("gromg05",Enemy()) ActionOverride("gromg08",Enemy()) ActionOverride("gromg09",Enemy()) ActionOverride("gromg10",Enemy())~ END
